       	...
       	<aside class="main-sidebar">
	        ...
	        <section class="sidebar">
	          ...
	          <ul class="sidebar-menu">
		            ...
		            <li class="treeview">
		              <a href="#" appdata-otype="mainlink" appdata-type="menulinkitem" appdata-name="clientprofile" appdata-fa='<i class="fa fa-user"></i>' appdata-pcrumb="Profile">
		            ...
		            <li class="treeview">
		              ...
		              <ul class="treeview-menu">
		                <li><a href="#New" appdata-otype="sublink" appdata-type="menulinkitem" appdata-name="newclientparentcontent" appdata-crumb="New Parent Content" appdata-fa='<i class="fa fa-tasks"></i>' appdata-pcrumb="Content"><i class="fa fa-plus"></i> New Parent Content</a></li>
		                <li><a href="#Edit" appdata-otype="sublink" appdata-type="menulinkitem" appdata-name="editclientparentcontent" appdata-crumb="Edit Parent Content" appdata-fa='<i class="fa fa-tasks"></i>' appdata-pcrumb="Content"><i class="fa fa-gear"></i> Edit Parent Content</a></li>
		                <li><a href="#Create/Edit Content Entries" appdata-otype="sublink" appdata-type="menulinkitem" appdata-name="createneditclientcontententries" appdata-crumb="Edit Content" appdata-fa='<i class="fa fa-tasks"></i>' appdata-pcrumb="Content"><i class="fa fa-gears"></i> Create/Edit Content Entries</a></li>
		            ...
		            <li class="treeview">
		              <a href="<?php echo $host_addr;?>snippets/logout.php?type=client" appdata-otype="mainlink" appdata-type="menulinkitem" appdata-name="logout">
