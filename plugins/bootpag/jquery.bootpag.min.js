...
(function(h, q) {
    h.fn.bootpag = function(p) {
        ...
        return this.each(function() {
            ...
            var dpag="";
            if(a.dataquery==true){
            	dq=['<div class="general_ajax_qdata"><input type="hidden" name="curquery" value="'+ a.datacurquery+ '"/><input type="hidden" name="datatarget" value="'+ a.datatarget+ '"/><input type="hidden" name="ipp" value="'+ a.dataipp+ '"/><input type="hidden" name="outputtype" value="'+ a.dataoutputtype+ '"/></div>'];	
	            ...
	            if(a.datavariant==true){
		            ...
		            dpag=['<div class="general_ajax_ipp"><div class="ipp_hold"><select name="general_ipp_select" data-curipp="'+a.dataipp+'" class="form-control general_ipp_select"><option value="">Select Number of Results Viewable</option>'+ opts +'</select></div></div>'];
	            }
            }
