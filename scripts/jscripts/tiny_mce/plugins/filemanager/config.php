...
$upload_dir = '/translynxng/media/multimedia/'; // path from base_url to upload base dir
$current_path = '../../../../media/multimedia/'; // relative path from filemanager folder to upload files folder
