...
$upload_dir = '/muyiwasblog/media/multimedia/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../media/multimedia/'; // relative path from filemanager folder to upload folder (with final /)
